...
class CampaignsRecords extends BaseDaktela
{
     ...
     * @return \Daktela\Request\DaktelaTicket|null
     * @throws \Daktela\Request\UnexpectedValueException public static function createCampaignsRecord(array $daktelaActivitiesData): ?DaktelaTicket
 *     {
 *         try {
