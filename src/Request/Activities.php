...
use App\Model\Entity\DaktelaTicket;
...
class Activities extends BaseDaktela
{
    ...
    public static function createActivity(array $daktelaActivitiesData): ?DaktelaTicket
    {
        try {
    ...
    public static function getActivity(int $daktelaActivitiesId): DaktelaTicket
    {
        try {
    ...
    public static function sendEmail(string $subject, string $message, string $recipients, string $queue, int $daktelaTicketId = null): ?DaktelaTicket
    {
    ...
    public static function sendSms(string $message, string $recipient, string $queue, int $daktelaTicketId = null): ?DaktelaTicket
    {
        return self::createActivity([
                    'type' => self::TYPE_SMS,
